  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 place-items-center gap-y-20">
        ...
        <SiPhp className="text-gray-500 text-7xl dark:text-gray-300 md:text-8xl" />
        ...
        <RiGatsbyFill className="text-gray-500 text-7xl dark:text-gray-300 md:text-8xl" />
        <SiGraphql className="text-gray-500 text-7xl dark:text-gray-300 md:text-8xl" />
