...
const Navigation = () => {
  ...
  return (
    <>
      {/* Toggle */}
      <div className="fixed w-full h-24 md:hidden top-0 left-0 bg-gray-100 dark:bg-gray-800 z-50">
        ...
        <div
          className={cls(
            `flex rounded-bl-lg bg-gray-100 dark:bg-gray-800  w-2/3 p-4 justify-end ml-auto flex-col space-y-4 items-start`,
            { hidden: isNavHidden }
          )}
        >
      ...
      {/* Desktop Nav */}
      <div
        className={`hidden md:flex md:items-center md:justify-between md:sticky top-0 h-20 bg-gray-100 dark:bg-gray-800 z-50`}
      >
